...
const Select: React.FC<Props> = ({name, options, type, defaultValue, placeholder}) => {

    const [selectedValue, setSelectedValue] = useState<string | string[]>(type === 'checkbox' ? [] : defaultValue!)
                            ...
                            onClick={() => {
                                ...
                                if (type === 'checkbox') {
                                    if (selectedValue.includes(item)) {
                                        const checkboxSelected = selectedValue as string[]
